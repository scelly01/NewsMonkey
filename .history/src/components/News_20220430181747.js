            ...
            <div className="container my-3">
                ...
                {this.state.loading && <Spinner />}
                 ...
                 {!this.state.loading && <div className="container d-flex justify-content-between" style={{padding:'30px 5px'}}>
                     ...
                     <button disabled={this.state.page+1 > Math.ceil(this.state.totalResults/this.props.pageSize)} type="button" className="btn yellow" onClick={this.handleNextClick}> Next &rarr;</button>
                 </div>}
